...
const Banner = () => {
  return (
    <div className="px-5 md:px-20 flex flex-col items-center bg-[#d2d2d2]/20">
      <h1 className="inter-font font-bold text-[40px] lg:text-[72px] text-[#001931] text-center text-base/20 mt-20">
        We Build <br />{" "}
      ...
      <div className="flex flex-col md:flex-row items-center gap-5 justify-center mt-10">
